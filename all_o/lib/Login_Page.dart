...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _resetPassword() async {
    await supabase.auth.resetPasswordForEmail(_usernameController.text);
  }
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 20,),
                  FadeInUp(duration: Duration(milliseconds: 1700), child: Center(child: TextButton(onPressed: _resetPassword, child: Text("Forgot Password?", style: TextStyle(color: Color.fromRGBO(196, 135, 198, 1)),)))),
                  SizedBox(height: 30,),
                  ...
                  SizedBox(height: 30,),
                  FadeInUp(duration: Duration(milliseconds: 2000), child: Center(
                    child: TextButton(
                      onPressed: _register,
